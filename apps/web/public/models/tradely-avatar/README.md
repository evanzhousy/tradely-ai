...
Original logo-derived geometry. The logo remains the canonical brand mark.

Editable source: `docs/brand/tradely-avatar.blend`. Separate body, wings, eye whites, and pupils. Rebuild from the repository root:
