...
const messages = {
	en: {
		...
		"hall.observeLabel": "Observe the market",
		"hall.observeTitle": "Every price tells part of a story.",
		"hall.observeBody":
			"Look closer. A change in price is where the question begins.",
		"hall.verifyLabel": "Build the context",
		"hall.verifyTitle": "The evidence connects the picture.",
		"hall.verifyBody":
			"Learn to connect flow, structure, and the question you set out to answer.",
		"hall.scroll": "Scroll to enter the floor",
		"hall.replay": "Replay the scene reveal",
	...
	zh: {
		...
		"hall.observeLabel": "观察市场",
		"hall.observeTitle": "每一个价格，只是故事的一部分。",
		"hall.observeBody": "看近一点。价格的变化，是提问的起点。",
		"hall.verifyLabel": "建立上下文",
		"hall.verifyTitle": "让证据，把图景连接起来。",
		"hall.verifyBody": "学习如何连接资金流、市场结构，以及你真正想回答的问题。",
