...
const scenes = [
	{
		...
		steps: teachingSteps(
			...
			[
				["Match chart to volume", "让图表匹配成交量"],
				["Detect metric mismatch", "识别指标错配"],
				["Match claim to premium", "让结论匹配权利金"],
			],
		),
	...
	},
	{
		...
		steps: teachingSteps(
			...
			[
				["Read axis origin", "读取坐标轴起点"],
				["Raise axis minimum", "提高坐标轴下限"],
				["Compare visual and true ratio", "比较视觉比与真实比"],
			],
		),
	...
	},
	{
		...
		steps: teachingSteps(
			...
			[
				["Spot the overclaim", "识别过度结论"],
				["Bound the headline", "收窄标题结论"],
				["Attach source and limits", "附上来源与限制"],
			],
		),
