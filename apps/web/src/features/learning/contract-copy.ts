...
export const contractCopy = {
	...
	spot: { en: "Fixed spot reference (USD)", zh: "固定现价参考（美元）" },
	itm: { en: "ITM · strike below spot", zh: "实值 · 行权价低于现价" },
	atm: { en: "ATM · strike equals spot", zh: "平值 · 行权价等于现价" },
	otm: { en: "OTM · strike above spot", zh: "虚值 · 行权价高于现价" },
	neighbors: {
		en: "Outlined cells share the selected strike or expiry.",
		zh: "边框单元格与所选合约拥有相同行权价或到期日。",
	},
