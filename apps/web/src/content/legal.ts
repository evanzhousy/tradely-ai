		...
		privacy: {
			...
			sections: [
				...
				},
				{
					...
					paragraphs: [
						"Our service providers may include Neon Auth for identity, Stripe for billing, Neon for the Tradely database, Vercel for application delivery, Cloudflare R2 for media storage, and PostHog and Google Analytics for consented product analytics and error diagnostics. They process information only as needed to provide their infrastructure and services.",
						"TradingFlow is an independent partnered product. Tradely does not share your Neon Auth account, billing record, learning record, or customer identifiers with TradingFlow. Links to TradingFlow are outbound practice links; any TradingFlow account or subscription is governed by TradingFlow's own terms and privacy practices.",
					],
				},
				{
				...
				},
				{
					...
					paragraphs: [
						"Depending on where you live, you may have rights to access, correct, delete, restrict, or export personal information, and to object to certain processing. We will verify requests and respond as required by applicable law. You can request account changes through Tradely support, manage billing details in Stripe's customer portal, and optional analytics through Privacy choices in the Tradely footer.",
					],
				},
				{
			...
			sections: [
				{
					...
					paragraphs: [
						"Tradely provides educational material, animated diagrams and worked examples about options research. The service is for learning and workflow practice only. It is not investment, legal, tax, accounting, or financial advice, and it does not recommend a security, trade, strategy, or position.",
					],
				},
				{
					heading: "Accounts and access",
					paragraphs: [
						"Keep your account information accurate and protect the credentials used with Neon Auth. Your account is personal unless Tradely has expressly agreed otherwise. Do not share access, bypass lesson controls, scrape protected media, or use another person's billing or account information.",
					],
				},
				{
					heading: "Free learning and previous purchases",
					paragraphs: [
						"All current Tradely visual lessons are free. A free account is required to save study marks across devices. Visual scene bookmarks are stored on this device. Earlier exercise records remain available to their owners. Guest practice resets on reload unless you explicitly request to save it. During sign-in, a temporary copy stays in the same browser tab for up to 24 hours and is removed after a confirmed account save or when the tab closes. Optional AI coaching has audience, usage, and shared budget limits and does not certify mastery. Previous purchases and subscriptions remain subject to their original billing terms and applicable refund and tax rules. Existing subscriptions must be canceled separately; free lesson access does not itself cancel them.",
					],
				},
				{
			...
			sections: [
				{
					...
					paragraphs: [
						"Authentication and security cookies support Neon Auth sessions and request protection. A local visual-scene bookmark remembers the last scene opened in each lesson on this device; it contains lesson and scene identifiers, not answers, and is not sent to analytics. When you choose to save a guest exercise, this tab temporarily stores its actions, responses, case version and save identifier during sign-in, for up to 24 hours. This copy is removed after successful saving or when the tab closes and is never sent to analytics. A small tab preference prevents repeated registration prompts. Public lessons remain available without an account.",
					],
				},
				{
				...
				},
				{
					...
					paragraphs: [
						"Use Privacy choices in the Tradely footer to allow or withdraw optional analytics at any time. Withdrawing consent stops PostHog and Google Analytics capture and resets the PostHog browser identity. You can also clear browser storage or block cookies through your browser settings. Blocking necessary storage may sign you out or prevent billing and protected lesson features from working.",
					],
				},
			],
		},
		...
		privacy: {
			...
			sections: [
				...
				},
				{
					heading: "你的选择与权利",
					paragraphs: [
						"根据所在地法律，你可能拥有访问、更正、删除、限制处理或导出个人信息，以及反对某些处理的权利。我们会验证请求，并依适用法律回复。你可以通过 Tradely 支持申请账户变更，在 Stripe 客户门户管理账单信息，并通过 Tradely 页脚的隐私设置管理可选分析。",
					],
				},
				{
					heading: "儿童与政策变更",
			...
			sections: [
				{
					heading: "教育服务",
					paragraphs: [
						"Tradely 提供关于期权研究的教育材料、动画图解与完整示例，仅用于学习和流程练习，不构成投资、法律、税务、会计或金融建议，也不推荐任何证券、交易、策略或仓位。",
					],
				},
				{
					heading: "账户与访问",
					paragraphs: [
						"请保持账户信息准确，并保护 Neon Auth 凭据。除非 Tradely 明确同意，账户仅限本人使用。不得分享访问权限、绕过课程控制、抓取受保护媒体，或使用他人的账单和账户信息。",
					],
				},
				{
					heading: "免费学习与历史购买",
					paragraphs: [
						"所有现有 Tradely 视觉课程均免费。跨设备保存学习标记需要免费账户，视觉场景书签保存在本设备。以前的练习记录仍供其所有者查看。访客练习在刷新后重置，除非你明确选择保存。登录期间，临时副本会在同一浏览器标签页保留最多 24 小时，并在确认保存到账户后或关闭标签页时移除。可选 AI 辅导受开放范围、使用次数与共享预算限制，不代表掌握认证。历史购买和订阅仍适用原有账单条款及相关退款和税务规则。已有订阅需单独取消，免费学习不会自动取消订阅。",
					],
				},
				{
			...
			sections: [
				{
					heading: "必要存储",
					paragraphs: [
						"身份验证和安全 Cookie 支持 Neon Auth 会话与请求保护。本设备的视觉场景书签记录各课最后打开的场景，仅含课程和场景标识，不包含回答，也不发送给分析服务。选择保存访客练习时，当前标签页会在登录期间暂存操作、回答、案例版本和保存标识，最多保留 24 小时；保存成功或关闭标签页后移除，且不会发送给分析服务。标签页偏好用于避免重复注册提示。未登录也可阅读课程并进行访客练习。",
					],
				},
				{
					heading: "偏好存储",
				...
				},
				{
					heading: "你的控制权",
					paragraphs: [
						"你可以随时通过 Tradely 页脚的隐私设置允许或撤回可选分析。撤回同意会停止 PostHog 和 Google Analytics 采集并重置 PostHog 浏览器身份。你也可以通过浏览器设置清除或阻止 Cookie；阻止必要存储可能导致退出登录，或使账单和受保护课程功能无法运行。",
					],
				},
			],
		},
