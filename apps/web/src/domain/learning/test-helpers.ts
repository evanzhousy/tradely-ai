...
export function referenceAction(question: ScenarioQuestion): LearningAction {
	return question.input ? { type: "respond", questionId: question.id, value: question.input.kind === "text" ? question.explanation.en : question.accepted[0] } : { type: "answer", questionId: question.id, choiceId: question.accepted[0] };
}
