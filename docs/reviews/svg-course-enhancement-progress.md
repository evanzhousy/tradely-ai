...
Current baseline: Lessons 1–25 have implemented SVG labs and individual review records. Final curriculum-wide completion still needs a fresh audit.
...
- Next implementation: Lesson 26, `audited-boundary`. Lesson 25 evidence and checks are recorded in `lesson-25-svg-lab-2026-09-12.md`.
...
- Lesson 26 (`audited-boundary`): construct explicit research subject, quantity, universe, time interval and evidence requirements. Separate descriptive from forecast requirements; classify observations/calculations/interpretations/contradictions/unknowns. Corrected evidence may test the same question; population or method changes require a new question with the original preserved. Keep reflective writing self-reviewed, not machine-certified.
...
- The owned production preview on port 8252 was stopped after Lesson 25 verification, ready for the next rebuild.
